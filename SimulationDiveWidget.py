...
class SimulationDiveWidget(QWidget):
    ...
    def init_ui(self):
        ...
        self.add_labeled_input(ship_x_layout, "目标舰艇位置y (m):", 1, 0, 0, 10000, 0, 1.0, "ship_x_z_input")
        self.add_labeled_input(ship_x_layout, "目标舰艇位置z (m):", 2, 0, 0, 10000, 0, 1.0, "ship_x_y_input")
        ...
        self.add_labeled_input(ship_x_layout, "目标舰艇速度Vy (m/s):", 6, 0, 0, 1000, 0, 1.0, "ship_v_z_input")
        self.add_labeled_input(ship_x_layout, "目标舰艇速度Vz (m/s):", 7, 0, 0, 1000, 0, 1.0, "ship_v_y_input")
